   ...
   function colorHandler(){
    setState( window.location.href)
        ...
        //  console.log(state);
         ...
         let state4 = false;
    // const [state,setState]= useState('');
    if (state==="https://chandanrealestate.onrender.com/display") {
        state1 = true;
        state2 = false;
        state3 = false;
       state4 = false;
      } else if  (state==="https://chandanrealestate.onrender.com/display2") {
        state1 = false;
        state2 = true;
        state3 = false;
       state4 = false;
      } else if  (state==="https://chandanrealestate.onrender.com/display3") {
        state1 = false;
        state2 = false;
        state3 = true;
       state4 = false;
      } else if(state==="https://chandanrealestate.onrender.com/display4"){
        state1 = false;
         state2 = false;
         state3 = false;
        state4 = true;
